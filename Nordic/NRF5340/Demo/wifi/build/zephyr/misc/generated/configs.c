...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 153600);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_ON_QSPI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_RADIO_COEX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_BT_COEX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_RX_NUM_BUFS, 48);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_MAX_TX_AGGREGATION, 12);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_SCAN_LIMIT, -1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_IFACE_WQ_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WEP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_CRYPTO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_WPA3, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_SOCKETPAIR_BUFFER_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_MAX_FDS, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_SOCKETS_POLL_MAX, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WPA_SUPP_DEBUG_LEVEL, 6);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STA_SAMPLE_SSID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STA_KEY_MGMT_WPA3, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STA_SAMPLE_PASSWORD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF700X_QSPI_ENCRYPTION_KEY, 1);
